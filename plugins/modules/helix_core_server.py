...
changed:
    ...
    sample: true
server_spec:
    description: The server specification after the operation.
    returned: always
    type: dict
    sample:
        ServerID: commit
    ...
    try:
        ...
        if module.params['state'] == 'present':
            ...
            if any(server_dict['ServerID'] == module.params['serverid'] for server_dict in servers_dict):
                ...
                field_changes = changed_fields(p4_server_spec, module.params, check_mapping, rstrip_fields=['Description'])
            ...
            result['server_spec'] = p4_server_spec
